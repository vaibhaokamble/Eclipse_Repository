...
class OnlineVotingSystem {
    ...
    public static void main(String[] args) {
        ...
        final JRadioButton r1 = new JRadioButton("BJP");
        final JRadioButton r2 = new JRadioButton("Congress");
        final JRadioButton r3 = new JRadioButton("BSP");
